 ...
 * @author kerch
 */
@WebServlet(name = "AWSDeleteServlet", urlPatterns = {"/AWSDeleteServlet"})
public class AWSDeleteServlet extends HttpServlet {
    ...
    protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        removeObjectFromBucket(bucketName, fileData.getFileName(), fileData.getFileMask());
        resp.sendRedirect("account.jsp");
    }
  
    
    private void removeObjectFromBucket(String backetName, String fileName, String fileMask){
        ...
        myS3ObjectService.deleteObject(backetName, fileName+"."+fileMask);
    }
}
